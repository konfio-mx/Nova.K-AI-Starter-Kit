"""
title: n8n Function to integrate with Open Web UI
author: Richard Hechenbichler
author_url: https://www.linkedin.com/in/richardh8/
version: 0.1.0
...
class Pipe:
    ...
    async def pipe(
        ...
        if messages:
            ...
            if "#### Tools Available" in question:
                question = question.split("#### Tools Available")[0].strip()
            try:
                # Invoke N8N workflow
                headers = {
